...
// Vibe-coded by Justin Patrick Dias
...
(function(thisObj)
{
    ...
    function buildUI(parent)
    {
        ...
        var pnlAffix = addSection(win, "Prefix / Suffix");
        var inputAffix = pnlAffix.add("edittext", undefined, "");
        inputAffix.alignment = ["fill", "top"];
        inputAffix.preferredSize.width = 260;
        inputAffix.minimumSize.width = 120;
        var rowAffixBtns = pnlAffix.add("group");
        rowAffixBtns.orientation = "row";
        rowAffixBtns.alignChildren = ["fill", "top"];
        rowAffixBtns.alignment = ["fill", "top"];
        var btnPrefix = rowAffixBtns.add("button", undefined, "Prefix");
        btnPrefix.alignment = ["fill", "top"];
        var btnSuffix = rowAffixBtns.add("button", undefined, "Suffix");
        btnSuffix.alignment = ["fill", "top"];

        // ---- Version section ----
        var pnlVersion = addSection(win, "Version");
        var btnBump = pnlVersion.add("button", undefined, "Version Up");
